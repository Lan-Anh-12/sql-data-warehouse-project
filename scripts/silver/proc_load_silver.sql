...
BEGIN TRY 
	...
	PRINT '=============================================='
	-- CLEAN silver.crm_cust_info
	SET @starttime = GETDATE();
	PRINT 'Truncating table: silver.crm_cust_info'
	TRUNCATE TABLE silver.crm_cust_info;
	PRINT 'Inserting data into: silver.crm_cust_info'
	INSERT INTO silver.crm_cust_info (
	cst_id, cst_key,cst_fistname,cst_lastname,cst_material_status,cst_gndr,cst_create_date
	)

	SELECT cst_id, cst_key,
	TRIM(cst_fistname ) AS cst_fistname,
	...
	-- CLEAN silver.crm_sales_details
	SET @starttime = GETDATE();
	...
	PRINT'----------------------------------------------------------'
	  ...
	  -- CLEAN silver.silver.erp_loc_a101
	SET @starttime = GETDATE();
